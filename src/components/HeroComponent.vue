    ...
    <v-container class="pt-15">
        <v-row>
            <v-col lg="6">
                ...
                <p class="description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam suscipit deleniti minus repellendus ipsum natus amet beatae facilis ab aut quod quo magnam doloribus, error cum minima! Nostrum, at inventore.</p>
